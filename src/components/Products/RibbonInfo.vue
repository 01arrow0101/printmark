...
const detailedRibbons = ref([
  ...
  },
  {
    id: 4,
    type: "resin-textile",
    title: "Смоляні Ріббони для Текстилю",
    imageUrl: folder("img/ribbon/resin-textile.webp"),
    fullDescription:
  ...
  },
  {
    id: 5,
    type: "hot-stamp",
    title: "Гаряче Тиснення (HotStamp)",
    imageUrl: folder("img/ribbon/hot-stamp.webp"), // переконайтеся, що файл завантажено
    fullDescription:
      "Спеціальна фольга для контактного маркування на термодатерах. Використовується для нанесення дати виробництва, номеру партії та терміну придатності безпосередньо на пакувальну плівку або картон.",
    compatibility:
      "Гнучка упаковка (BOPP, ПЕ, ПЕТ), папір, ламінований картон.",
    resistance:
      "Висока стійкість до низьких температур (заморожування) та стирання.",
    application:
      "Харчова промисловість (дати на пакетах), фармацевтика, маркування кабельної продукції.",
    path: "/products/ribbons/hotstamp",
  },
  {
    id: 6,
    type: "inline",
    title: "Ріббони для In-Line принтерів (TTO)",
    imageUrl: folder("img/ribbon/In-Line.webp"), // переконайтеся, що файл існує
    fullDescription:
      "Спеціалізовані ріббони технології Near-Edge, розроблені для інтеграції у високошвидкісні пакувальні лінії (TTO). Забезпечують ідеальну чіткість друку на гнучких плівках при екстремальних швидкостях.",
    compatibility:
      "Принтери Videojet, Markem-Imaje, Domino, Linx, Allen Coding.",
    resistance:
      "Висока стійкість до тертя, гнучкості упаковки та перепадів температур.",
    application:
      "Маркування дати, штрих-кодів та QR-кодів безпосередньо на пакувальній лінії (Flow-pack).",
    path: "/in-line",
  },
]);
</script>
...
.badge {
  ...
  color: white;
  &.inline {
    background-color: #d4af37; // Ваш золотий колір для преміального продукту
  }
}
