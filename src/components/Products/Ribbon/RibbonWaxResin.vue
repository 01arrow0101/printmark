...
const info = {
  description:
    "Ріббони WAX/RESIN (віск/смола) являють собою золоту середину між швидкістю та стійкістю. Фарбуючий шар містить суміш воску та синтетичних смол (резинів), причому смоли забезпечують значно кращу адгезію та опірність. Для друку потрібна трохи вища температура, ніж для чистого воску.",
  advantages: [
