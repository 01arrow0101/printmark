...
const ribbons = [
  {
    title: "WAX (ВОСК)",
    image: folder("ribbon/green.webp"), // <-- Використовуємо функцію
    description:
  ...
  },
  {
    ...
    image: folder("ribbon/black.webp"), // <-- Використовуємо функцію
    description:
  ...
  {
    title: "RESIN (СМОЛА)",
    image: folder("ribbon/white.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("ribbon/Metallic.webp"),
    description:
  ...
  image: folder("ribbon/hot-stamp.webp"), // Переконайтеся, що файл hot-stamp.webp є в папці ribbon
  description:
...
const tables = [
  {
    ...
    image: folder("label/paper-labels.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("label/synthetic-labels.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("label/heat-resistant-labels.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("label/waterproof-labels.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("label/warehouse-labels.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("label/electronics-labels.webp"),
    description:
...
const services = [
  {
    ...
    image: folder("services/порізка.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("services/підтримка.webp"),
    description:
