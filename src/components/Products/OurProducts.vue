...
const ribbons = [
  ...
  },
  {
    ...
    image: folder("img/ribbon/red-metallic.webp"),
    description:
  ...
  {
    title: "IN-LINE (NEAR-EDGE)",
    image: folder("img/ribbon/In-Line.webp"), // Переконайтеся, що файл inline-near-edge.webp є в папці ribbon
    description:
      "Високотехнологічні ріббони для швидкісних маркувальних систем (TTO), інтегрованих безпосередньо у виробничі лінії. Спеціальне антистатичне покриття захищає термоголовку кутового типу (Near-Edge) від зносу та перегріву. Забезпечують миттєве закріплення відбитку на швидкостях до 1000 мм/с. Ідеально підходять для принтерів Videojet, Markem-Imaje та Domino.",
  },
];
