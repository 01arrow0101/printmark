      ...
      <div class="product-card">
        ...
        <div class="card-content">
          ...
          <div class="product-details">
            ...
            <h3 class="subtitle">⚠️ Рекомендований Ріббон та Стійкість:</h3>
            <ul class="spec-list">
              <li>
                <p class="subtitle">"Рекомендований Ріббон:",</p>
              </li>
...
const info = {
  ...
  limitations: [
    "Для найкращого результату використовуйте WAX (Восковий) Ріббон.",
    "Для підвищення стійкості до змащування можна використовувати WAX/RESIN Ріббон.",
