...
const technologies = [
  {
    ...
    image: folder("tehnology/високоточнаПорізка.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("tehnology/матеріал.webp"), // Це зображення може потребувати оновлення, якщо воно було про термостійкість, а не порізку спец. матеріалів
    description:
  ...
  },
  {
    ...
    image: folder("tehnology/екологічність.webp"),
    description:
...
const equipments = [
  {
    ...
    image: folder("tehnology/lazer.webp"),
    description:
  ...
  //   image: folder("tehnology/peremotka.webp"),
  //   description:
  ...
  // },
  {
    ...
    image: folder("tehnology/control.webp"),
    description:
