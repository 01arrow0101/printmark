...
const technologies = [
  {
    ...
    image: folder("img/tehnology/високоточнаПорізка.webp"),
    description:
  ...
  },
  {
    ...
    image: folder("img/tehnology/матеріал.webp"), // Це зображення може потребувати оновлення, якщо воно було про термостійкість, а не порізку спец. матеріалів
    description:
  ...
  },
  {
    ...
    image: folder("img/tehnology/екологічність.webp"),
    description:
      "Ми оптимізуємо виробничі процеси для мінімізації відходів. Використовуємо енергоефективне обладнання та екофрендлі матеріали. Ми дбаємо про екологічність нашого виробництва, забезпечуючи високоякісні результати.",
  },
];

const equipments = [
  {
    title: "Системи Ротаційної Порізки",
    image: folder("img/tehnology/lazer.webp"),
    description:
      "Сучасні ротаційні системи з автоматичним керуванням, призначені для порізки рібонів та етикеток з точністю до 0.01 мм. Забезпечують бездоганні краї та відповідність заданим розмірам.",
  },
  // {
  //   title: "Автоматизовані Лінії Перемотування",
  //   image: folder("img/tehnology/peremotka.webp"),
  //   description:
  ...
  // },
  {
    ...
    image: folder("img/tehnology/control.webp"),
    description:
