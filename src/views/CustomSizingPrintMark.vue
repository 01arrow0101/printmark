<template>
  ...
  <section class="custom-config-section">
    <div class="container">
      <h1 class="title">
        Індивідуальне Виробництво: Етикетки та Ріббони
      ...
      <div class="info-block custom-ribbon-params">
        <div class="card-header">
          <h2 class="subtitle">⚫️ Індивідуальні Параметри Ріббонів (Нарізка)</h2>
        </div>
...
// 3. Параметри, що налаштовуються для РіббонІВ (Новий блок, інтегрований у стиль карток)
const ribbonParams = ref([
  {
    title: "Ширина Ріббона (Cutting Width)",
    description: "Точна нарізка ширини Ріббона (наприклад, 40, 55, 60, 80, 110 мм) під розмір вашої етикетки та принтера, щоб уникнути перевитрати матеріалу.",
  },
  {
...
const orderingSteps = ref([
  {
    title: "Опис Завдання",
    description: "Ви надаєте розмір (ШхД), матеріал (Папір/ПП), тип Ріббона та модель вашого принтера.",
  },
  {
    title: "Технічне Узгодження",
    description: "Наш фахівець підтверджує можливість виготовлення етикеток та нарізки Ріббонів, узгоджуючи всі параметри.",
  },
  {
